...
export default function Notepop(props) {
  ...
  const handleSave = () => {
    editNotes(noteId, document.getElementById("title").textContent, document.getElementById("description").textContent)
  ...
  const fetchNoteId = () => {
    ...
    setnoteId(window.location.href.slice(index + 1,))
  }
    ...
    notebyId[0] && <div class="notepop">
      <div className='notepopinner'>
        <div className='noterpopinnertop'>
          ...
          <div className='middle'>{"Created: "+notebyId[0]['createdAt'].slice(0,10) + " at "+ notebyId[0]['createdAt'].slice(11,19) }</div>
          <div className='right'>
